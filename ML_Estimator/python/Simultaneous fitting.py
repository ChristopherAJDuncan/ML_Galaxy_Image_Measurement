...
for j in range(len(area_value)):
	...
	for i in range(numb_iter):
		...
		extra_gal, disc = modPro.user_get_Pixelised_Model(get_Image_params(imageParams), noiseType = None, outputImage = True, sbProfileFunc = SBPro.gaussian_SBProfile_CXX, der = der)
